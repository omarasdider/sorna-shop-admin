...
interface ProductFormProps{
 ...
 export const ProductForm: React.FC<ProductFormProps> = ({
    ...
    const tostMessage = initialData ? "Product update" : " Product create"
        ...
        >
         ...
         <div className="grid grid-cols-3 gap-8">
           ...
           defaultValue={field.value}>
            ...
            name="isFeatured"
            render={({ field}) => (
             <FormItem className="flex items-start space-x-3 space-y-0 rounded-sm border p-4 ">
             <FormControl>
                <Checkbox 
                checked={field.value}
            ...
            <FormDescription>
                This product will not appear in the  anywhere store
            </FormDescription>
             </div>
             </FormItem>
            )}
